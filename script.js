...
function initFloatingImages() {
    ...
    document.querySelectorAll('.couple-image-container, .bride-image-container, .groom-image-container').forEach(container => {
    ...
    function createHearts(container) {
        ...
        for (let i = 0; i < heartCount; i++) {
            setTimeout(() => {
                ...
                heart.classList.add('heart');
                heart.innerHTML = '❤️';
                heart.style.color = container.classList.contains('bride') ? '#ffb6c1' : '#ff6b8b';
